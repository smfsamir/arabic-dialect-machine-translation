...
# TODO: need to change for 
ARA_SCRIPT_DIR="/home/fsamir8/projects/def-mageed/fsamir8/arabic-dialect-machine-translation/packages/ara_t5_scripts"
LOGGING_DIR="/home/fsamir8/scratch/ara_dial_translation"
MODEL_DIR="/home/fsamir8/projects/def-mageed/fsamir8"

# source /project/rrg-mageed/fsamir8/dia_env/bin/activate
# The order of these commands seems to matter...
source /home/fsamir8/projects/def-mageed/fsamir8/py3env/bin/activate
...
python "run_trainier_seq2seq_huggingface.py" \
        ...
        --do_train --predict_with_generate --task $task --text_column $text_col --summary_column $label_col